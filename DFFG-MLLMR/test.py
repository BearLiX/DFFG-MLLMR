...
def parse_agrs():
    ...
    parser.add_argument('--dataset_name', type=str, default='mimic_cxr') #'iu_xray', 'mimic_cxr'
    ...
    parser.add_argument('--restore_dir', type=str, default='./results/mimic-1/', help='the path to load the models.')
    parser.add_argument('--checkpoint_dir', type=str, default='6.pth', help='the checkpont.')  
