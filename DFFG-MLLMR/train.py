...
def parse_agrs():
    ...
    parser.add_argument('--image_dir', type=str, default= r'/root/autodl-tmp/mimic/MIMIC-CXR-JPG-2.1.0/physionet.org/files/mimic-cxr-jpg/2.1.0/files/, help='the path to the directory containing the data.')  
    parser.add_argument('--ann_path', type=str, default= r'/root/autodl-tmp/mimic/MIMIC-CXR-JPG-2.1.0/mimic_annotation_tag.json', help='the path to the directory containing the data.')

    # Data loader settings
    parser.add_argument('--dataset_name', type=str, default='iu_xray')  #'iu_xray', 'mimic_cxr'
    ...
    parser.add_argument('--RoundGap', type=int, default=6, help='the alternative training epochs in a round.')
    parser.add_argument('--save_dir', type=str, default='./results/iu-121/', help='the patch to save the models.')
    parser.add_argument('--save_period', type=int, default=1, help='the saving period.')
    parser.add_argument('--monitor_mode', type=str, default='max', choices=['min', 'max'], help='whether to max or min the metric.')
    parser.add_argument('--monitor_metric', type=str, default='BLEU_4', help='the metric to be monitored.')
    parser.add_argument('--early_stop', type=int, default=200, help='the patience of training.')
